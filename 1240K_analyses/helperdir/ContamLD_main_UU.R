...
snpfile2=read.table(paste(args[3],"_reads_107k_D.txt",sep=""),header=F)

### Get just UU sites
snpfile[,3]=snpfile[,3]-snpfile2[,3]
snpfile[,4]=snpfile[,4]-snpfile2[,4]
...
write.table(Table5,file=paste(args[3],"_UU_",args[4],"panel_1ind_noChr","0","_alphatable_fullreads.txt",sep=""),sep="\t",quote=FALSE,col.names=FALSE,row.names=FALSE)
write.table(top,file=paste(args[3],"_UU_",args[4],"panel_1ind_noChr","0","_topscore_fullreads.txt",sep=""),sep="\t",quote=FALSE,col.names=FALSE,row.names=FALSE)
...
top=Table5[which.max(Table5[,2]),]
write.table(Table5,file=paste(args[3],"_UU_",args[4],"panel_1ind_noChr",f,"_alphatable_fullreads.txt",sep=""),sep="\t",quote=FALSE,col.names=FALSE,row.names=FALSE)
write.table(top,file=paste(args[3],"_UU_",args[4],"panel_1ind_noChr",f,"_topscore_fullreads.txt",sep=""),sep="\t",quote=FALSE,col.names=FALSE,row.names=FALSE)
}
