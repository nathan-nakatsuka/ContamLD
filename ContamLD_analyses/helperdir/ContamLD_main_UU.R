...
snpfile=read.table(paste(args[3],"_reads_",args[4],"panel_",args[5],".txt",sep=""),header=F)
snpfile2=read.table(paste(args[3],"_reads_",args[4],"panel_",args[5],"_D.txt",sep=""),header=F)
...
write.table(Table5,file=paste(args[3],"_UU_",args[4],"_",args[5],"panel_1ind_noChr","0","_alphatable_fullreads.txt",sep=""),sep="\t",quote=FALSE,col.names=FALSE,row.names=FALSE)
write.table(top,file=paste(args[3],"_UU_",args[4],"_",args[5],"panel_1ind_noChr","0","_topscore_fullreads.txt",sep=""),sep="\t",quote=FALSE,col.names=FALSE,row.names=FALSE)
...
top=Table5[which.max(Table5[,2]),]
write.table(Table5,file=paste(args[3],"_UU_",args[4],"_",args[5],"panel_1ind_noChr",f,"_alphatable_fullreads.txt",sep=""),sep="\t",quote=FALSE,col.names=FALSE,row.names=FALSE)
write.table(top,file=paste(args[3],"_UU_",args[4],"_",args[5],"panel_1ind_noChr",f,"_topscore_fullreads.txt",sep=""),sep="\t",quote=FALSE,col.names=FALSE,row.names=FALSE)
}
